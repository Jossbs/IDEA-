...
| `translated_subject_name` | VARCHAR(100)    | Nullable                  | Allows side-by-side display of the subject in a second language.                  |
...
- Source of the **system-wide conventions**: UUID PKs, verbose `snake_case`,
  soft-delete (`is_active_record`), audit timestamps, and optional `translated_*`
  fields for bilingual display.
